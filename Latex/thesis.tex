...
\setboolean{researchquestions}{true}
...
\emph{This chapter is based on a previous publication: \bibentry{Hoonhout2017a}.}

\input{largescale}

\chapter{Small scale sediment transport} \label{ch:smallscale}

\emph{This chapter is based on a previous publication: \bibentry{Hoonhout2017b}.}
